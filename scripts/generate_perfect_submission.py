...
def generate_random_submission(task, reference_dir, scoring_index_file, output_dir, text_gap, time_gap, merge_label):
...
def main():
	...
	generate_random_submission(args.task, args.reference_dir, args.scoring_index_file, args.output_dir, merge_ref_text_gap, merge_ref_time_gap, args.merge_ref_label)
