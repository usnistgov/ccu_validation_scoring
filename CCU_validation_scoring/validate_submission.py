...
def global_subm_checks(task, reference_dir, submission_dir):
	...
	check_submission_files(submission_dir, index_file_path, subm_file_length_dict)

	return ref, subm_file_length_dict
...
def validate_nd_submission_dir_cli(args):
	...
	task = "norms"
	ref, subm_file_length_dict = global_subm_checks(task, args.reference_dir, args.submission_dir)
