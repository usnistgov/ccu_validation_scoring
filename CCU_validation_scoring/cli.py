...
def main():
    ...
    score_nd_parser.add_argument("-aC", "--time_span_scale_collar", nargs='?', default="15", help="The duration of TP and FP Scaling collar for audio")
    score_nd_parser.add_argument("-xC", "--text_span_scale_collar", nargs='?', default="150", help="The duration of TP and FP Scaling collar for text")
