...
class IOUTests_v2(unittest.TestCase):
    ...
    def setUp(self):
        ##############################  IoU     Inter Union   csb   cse   ScTP      ScFP
        self.cases = [ { 'expected': [ [0.75],   [30], [40], [20], [60],  [1.0],    [0.333] ] ,  'inputs': { 'file': 'F4', 'ref':  [ [ 25, 55 ] ], 'hyp': [20, 60] , 'type': 'audio' , 'collar': 15} }, 
                       { 'expected': [ [0.75],   [30], [40], [20], [60],  [1.0],    [0.0] ] ,    'inputs': { 'file': 'F5', 'ref':  [ [ 20, 60 ] ], 'hyp': [25, 55] , 'type': 'audio' , 'collar': 15} },
                       { 'expected': [ [0.4286], [30], [70],  [5], [75],  [1.0],    [1.333] ] ,  'inputs': { 'file': 'F6', 'ref':  [ [ 25, 55 ] ], 'hyp': [ 5, 75] , 'type': 'audio' , 'collar': 15} },
                       { 'expected': [ [0.4286], [30], [70], [10], [70],  [0.8571], [0.0] ] ,    'inputs': { 'file': 'F7', 'ref':  [ [  5, 75 ] ], 'hyp': [25, 55] , 'type': 'audio' , 'collar': 15} },
                       { 'expected': [ [0.5454], [30], [55], [20], [75],  [1.0],    [0.5714] ] , 'inputs': { 'file': 'F8', 'ref':  [ [ 20, 55 ] ], 'hyp': [25, 75] , 'type': 'audio' , 'collar': 15} },
                       { 'expected': [ [0.50],   [30], [60], [10], [65],  [0.9],    [0.2] ] ,    'inputs': { 'file': 'F9', 'ref':  [ [  5, 55 ] ], 'hyp': [25, 65] , 'type': 'audio' , 'collar': 15} },
                       { 'expected': [ [0.5454], [30], [55], [20], [70],  [0.9],    [0.1] ] ,    'inputs': { 'file': 'F10', 'ref': [ [ 25, 75 ] ], 'hyp': [20, 55] , 'type': 'audio' , 'collar': 15} },
                       { 'expected': [ [0.1667], [10], [60],  [5], [50],  [0.625],  [0.5] ] ,    'inputs': { 'file': 'F11', 'ref': [ [ 25, 65 ] ], 'hyp': [ 5, 35] , 'type': 'audio' , 'collar': 15} },
                       { 'expected': [ [0.0], [0], [90],  [45], [100],  [0.0],  [1.0] ] ,    'inputs': { 'file': 'F11', 'ref': [ [ 10, 40 ] ], 'hyp': [ 60, 100] , 'type': 'audio' , 'collar': 15} },
                       { 'expected': [ [0.75, 0.4],   [30, 20], [40, 50], [20, 20], [60, 70],  [1.0, 1.0],    [0.333, 0.6667] ] ,  'inputs': { 'file': 'Multi', 'ref':  [ [ 25, 55 ], [ 40, 70 ] ], 'hyp': [20, 60] , 'type': 'audio' , 'collar': 15} },
                       { 'expected': [ [0.1429], [3], [21],  [20], [40],  [1],  [0.9091] ] ,    'inputs': { 'file': 'F12', 'ref': [ [ 30, 40 ] ], 'hyp': [ 20, 32] , 'type': 'text' , 'collar': 150} },
                       { 'expected': [ [0.3333], [11], [33],  [20], [52],  [1],  [2] ] ,    'inputs': { 'file': 'F12', 'ref': [ [ 30, 40 ] ], 'hyp': [ 20, 52] , 'type': 'text' , 'collar': 150} },
                       { 'expected': [ [0.1176], [26], [221],  [80], [275],  [0.8756],  [0.0995] ] ,    'inputs': { 'file': 'F12', 'ref': [ [ 100, 300 ] ], 'hyp': [ 80, 125] , 'type': 'text' , 'collar': 150} }
                       ]
    ...
    def test_iou(self):
        ...
        for case in range(len(self.cases)):
            ...
            ret = segment_iou_v2(self.cases[case]['inputs']['hyp'][0],
                                 ...
                                 False,
                                 [ d.start, d.end],
                                 self.cases[case]['inputs']['collar'],
                                 self.cases[case]['inputs']['type'])
