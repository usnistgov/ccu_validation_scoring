...
class NormDiscoveryTests(unittest.TestCase):
    ...
    def test_merge_vote_time_periods(self,input_file_path="test/scores/unittests//mergeInputFile1.txt", expected_path_file="test/scores/unittests/mergeExpectedFile1.txt"): # /Users/cnc30/Documents/VisualStudioProjects/ccu_validation_scoring/test/scores/unittests/mergeInputFile1.txt
